...
function [name,letter,polarity,all]=aaname(aa)
    ...
    if aa== 1, name='ALA';letter='A';polarity='PP';all=' 1=ALA=A:PP';
elseif aa== 2, name='ARG';letter='R';polarity='P0';all=' 2=ARG=R:P0';
elseif aa== 3, name='ASN';letter='N';polarity='PP';all=' 3=ASN=N:PP';
elseif aa== 4, name='ASP';letter='D';polarity='PP';all=' 4=ASP=D:PP';
elseif aa== 5, name='CYS';letter='C';polarity='HH';all=' 5=CYS=C:HH';
elseif aa== 6, name='GLN';letter='Q';polarity='PP';all=' 6=GLN=Q:PP';
elseif aa== 7, name='GLU';letter='E';polarity='PP';all=' 7=GLU=E:PP';
elseif aa== 8, name='GLY';letter='G';polarity='PP';all=' 8=GLY=G:PP';
elseif aa== 9, name='HIS';letter='H';polarity='PP';all=' 9=HIS=H:PP';
elseif aa==10, name='ILE';letter='I';polarity='HH';all='10=ILE=I:HH';
elseif aa==11, name='LEU';letter='L';polarity='HH';all='11=LEU=L:HH';
elseif aa==12, name='LYS';letter='K';polarity='PP';all='12=LYS=K:PP';
elseif aa==13, name='MET';letter='M';polarity='HH';all='13=MET=M:HH';
elseif aa==14, name='PHE';letter='F';polarity='HH';all='14=PHE=F:HH';
elseif aa==15, name='PRO';letter='P';polarity='P1';all='15=PRO=P:P1';
elseif aa==16, name='SER';letter='S';polarity='PP';all='16=SER=S:PP';
elseif aa==17, name='THR';letter='T';polarity='PP';all='17=THR=T:PP';
elseif aa==18, name='TRP';letter='W';polarity='H0';all='18=TRP=W:H0';
elseif aa==19, name='TYR';letter='Y';polarity='H0';all='19=TYR=Y:H0';
elseif aa==20, name='VAL';letter='V';polarity='HH';all='20=VAL=V:HH';
