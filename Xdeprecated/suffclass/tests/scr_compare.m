...
np=[0,2,1,2,1,3,5,2]*50;      % number of data points per class
var=[1,1 2 2 1 1 2 2 2]*10;     % std of classes
fac=[1,1,1,1,1,1,1,1,1]*120;    % approx box size (fac/var=12 is interesting)

alg = 1;                % 1 = old estimator (_obsolete/classpot.m), 2 = new estimator (suff_pot.m)
if (alg == 1) addpath('_obsolete'); end        
...
save scr_compare0 new sup opt draw
